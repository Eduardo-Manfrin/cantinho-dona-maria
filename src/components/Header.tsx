    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-primary/95 backdrop-blur-sm">
      <div className="container mx-auto">
        <div className="flexBetween py-4">
          {/* Logo */}
          <a href="#" className="flexCenter gap-3">
            <div className="w-12 h-12 rounded-full bg-secondary flexCenter">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="#cardapio" className="text-primary-foreground/90 hover:text-secondary transition-colors font-medium">
              {t.nav.menu}
            </a>
